...
const bracket = createBracket(
    ...
    document.querySelector('.common-bracket-wrapper'),
    {
        ...
        getMatchTopHTML: () => `<span style="background: pink; color: black; padding: 1px 3px;">match top</span>`,
        getMatchBottomHTML: () => `<span style="background: gainsboro; color: black; padding: 1px 3px;">match bottom</span>`,
        matchMinVerticalGap: 55,
